...
const videoGuides: VideoGuide[] = [
  {
    ...
    description: 'Comprehensive visual guide to performing all Hajj rituals correctly.',
    duration: '28:00',
    views: '2.1M',
    thumbnail: 'https://img.youtube.com/vi/iyOF_9cjGa0/maxresdefault.jpg',
    youtubeId: 'iyOF_9cjGa0',
    category: 'ritual',
  },
  {
    id: '2',
    title: 'How to Wear Ihram',
    description: 'Quick 2-minute guide on making intention and wearing Ihram properly.',
    duration: '2:00',
    views: '890K',
    thumbnail: 'https://img.youtube.com/vi/zizUBGxEh2Q/maxresdefault.jpg',
    youtubeId: 'zizUBGxEh2Q',
    category: 'ritual',
  },
  {
    id: '3',
    ...
    duration: '18:45',
    views: '1.5M',
    thumbnail: 'https://img.youtube.com/vi/VjoxX87BTtw/maxresdefault.jpg',
    youtubeId: 'VjoxX87BTtw',
    category: 'spiritual',
  },
  {
    id: '4',
    title: 'What to Do on Day of Arafah',
    description: 'Spiritual guidance and practices for the blessed day of Arafah.',
    duration: '15:30',
    views: '650K',
    thumbnail: 'https://img.youtube.com/vi/6GTPAi0Imd0/maxresdefault.jpg',
    youtubeId: '6GTPAi0Imd0',
    category: 'spiritual',
  },
  {
    id: '5',
    title: 'Hajj 2025: Top Tips for First-Time Pilgrims',
    description: 'Essential tips and practical advice for your first Hajj journey.',
    duration: '25:00',
    views: '780K',
    thumbnail: 'https://img.youtube.com/vi/gRX3GfhzXVU/maxresdefault.jpg',
    youtubeId: 'gRX3GfhzXVU',
    category: 'practical',
  },
  {
    id: '6',
    title: 'How to Perform Umrah - Full Guide',
    description: 'Complete step-by-step Umrah guide from first-person perspective.',
    duration: '22:00',
    views: '3.2M',
    thumbnail: 'https://img.youtube.com/vi/upncYHG5EmM/maxresdefault.jpg',
    youtubeId: 'upncYHG5EmM',
