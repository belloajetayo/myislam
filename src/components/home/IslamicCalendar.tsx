...
import { ChevronLeft, ChevronRight, ChevronUp, ChevronDown, Moon, MapPin, Sparkles, Calendar } from 'lucide-react';
      ...
      <div className="relative">
        ...
        {!isExpanded && (
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <span>{currentMonthInfo?.en} {currentHijriYear} هـ</span>
            <span className="font-arabic text-islamic-gold">{currentMonthInfo?.ar}</span>
          </div>
        )}
      </div>
    </div>
