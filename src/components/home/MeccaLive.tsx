...
const MeccaLive: React.FC = () => {
  ...
  // Official KSA Qur'an TV Makkah livestream channel.
  // YouTube resolves the currently active broadcast for this verified channel.
  const muteParam = isMuted ? 1 : 0;
  const youtubeEmbedUrl = `https://www.youtube.com/embed/live_stream?channel=UCos52azQNBgW63_9uDJoPDA&autoplay=1&mute=${muteParam}&rel=0&modestbranding=1&playsinline=1&enablejsapi=1`;
    ...
    >
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-center gap-2 pt-2 border-t border-border/50">
          ...
          <a
            href="https://www.youtube.com/channel/UCos52azQNBgW63_9uDJoPDA/live"
            target="_blank"
