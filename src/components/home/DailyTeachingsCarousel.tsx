    ...
    <div className="relative bg-card rounded-3xl overflow-hidden shadow-card border border-border animate-slide-up" style={{ animationDelay: '0.2s' }}>
      ...
      <div className="flex items-center justify-between p-3 border-b border-border/50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-foreground">{teaching?.category || 'Daily Teaching'}</span>
        </div>
      ...
      <div className="relative min-h-[320px] overflow-hidden">
        ...
        <div className="relative flex flex-col p-5 text-white">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-islamic-gold font-semibold text-lg">{teaching?.category}</span>
          </div>
          ...
          <div className="mt-auto pt-2 border-t border-white/20">
            <p className="text-[11px] font-medium text-islamic-gold">MyIslam App</p>
          </div>
        </div>
